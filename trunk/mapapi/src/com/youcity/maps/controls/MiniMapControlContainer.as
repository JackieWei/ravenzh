...
//			_miniMap.zoom = _control.mapping(map.zoom);
			...
			//_miniMap.addEventListener(MapEvent.ZOOM_CHANGED, handleMiniMapZoomChangedEvent);
		 ...
		 * 
		 */		
		private function handleMiniMapZoomChangedEvent(event:MapEvent):void
		{
			map.setZoom(_control.mapping[_miniMap.zoom]);
		}
