package com.youcity.maps.controls
{
	...
	public class PositionContainer extends ControlContainer
	{
		...
		{
			if (map.currentMapType == MapTypeConstants.getManhattan2DMap())
			{
				drawContainer(POSITION_CONTROL_2D);
				_mapTypeControl.setMapType("3d");
				return;
			}
			if(map.currentMapType == MapTypeConstants.getManhattan3DMap())
			{
				drawContainer(POSITION_CONTROL_3D);
				_mapTypeControl.setMapType("2d");
			}
		}
