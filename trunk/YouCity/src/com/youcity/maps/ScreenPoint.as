package com.youcity.maps
{
	...
	public class ScreenPoint extends Point
	{
		 ...
		 * 
		 */		
		public function offsetPoint(dx:Number, dy:Number):ScreenPoint//根据一定的偏移量得到新的screenpoint，注意不会改变当前实例
		{
		 ...
		 * 
		 */		
		public function equalsTo(toCompare:ScreenPoint):Boolean//判断两个screenPoint是否是指向同一个zoom的同一个点
		{
			if (toCompare.x == x && toCompare.y == y && toCompare.zoom == _zoom)
			{
				return true;
			}
			return false;
