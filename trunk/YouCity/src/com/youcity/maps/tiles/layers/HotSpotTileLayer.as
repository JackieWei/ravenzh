package com.youcity.maps.tiles.layers
{
	 ...
	 */	
	public class HotSpotTileLayer extends MonoTileLayer
	{
		/**
		 * 
		 * @param name : name
		 ...
		 * 
		 */		
		public function HotSpotTileLayer(name:String, url:String, tileBuffer:uint = 0, fileExtName:String = 'xml',  direction:String = MapConstants.SOUTH, showProgress:Boolean = false, tileWidth:uint = 256, tileHeight:uint = 256) 
		{
